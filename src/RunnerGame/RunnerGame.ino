...
// Initialize LCD with pin mapping
...
/**
 * Loads custom 5x8 bitmasks into LCD CGRAM
 */
void initializeGraphics(){
  static byte graphics[] = {
    // Run 1, Run 2, Jump, Jump Lower, Solid, Solid Right, Solid Left
...
/**
 * Shifts terrain left and injects new obstacles
 */
...
/**
 * Renders Hero based on FSM state and calculates collisions
 */
...
void setup(){
  ...
  digitalWrite(PIN_BUTTON, HIGH); // Internal Pull-up
